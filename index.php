    ...
    <div class="carousel-inner">
      <div class="carousel-item active" style="background-image: url('images/slider1.jpg');">
        <div class="carousel-caption text-center">
          ...
          <a href="contact.php" class="btn btn-primary2 mt-3">Request Service</a>
        </div>
      </div>
      <div class="carousel-item" style="background-image: url('images/slider2.jpg');">
        <div class="carousel-caption text-center">
          ...
          <a href="services.php" class="btn btn-primary2 mt-3">View Services</a>
        </div>
      </div>
      <div class="carousel-item" style="background-image: url('images/slider3.jpg');">
        <div class="carousel-caption text-center">
          ...
          <a href="about.php" class="btn btn-primary2 mt-3">Learn More</a>
        </div>
      </div>
    </div>
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="testimonial-card p-4 bg-white shadow rounded-3">
            <img src="images/team3.jpg" alt="Client 1" class="rounded-circle mb-3 client-img">
        ...
        <div class="swiper-slide">
          <div class="testimonial-card p-4 bg-white shadow rounded-3">
            <img src="images/team1.png" alt="Client 2" class="rounded-circle mb-3 client-img">
        ...
        <div class="swiper-slide">
          <div class="testimonial-card p-4 bg-white shadow rounded-3">
            <img src="images/team3.jpg" alt="Client 3" class="rounded-circle mb-3 client-img">
        ...
        <div class="swiper-slide">
          <div class="testimonial-card p-4 bg-white shadow rounded-3">
            <img src="images/team2.jpg" alt="Client 3" class="rounded-circle mb-3 client-img">
            <h5 class="fw-bold text-dark">Mr. Ajay Saxena</h5>
            <p class="text-muted mb-1">LifeLine Clinic</p>
            <div class="stars mb-3">⭐⭐⭐⭐⭐</div>
            <p class="testimonial-text text-secondary">
              “Reliable and trustworthy team. They repaired our ultrasound equipment quickly with genuine parts.”
...
<section class="trusted-section py-5 bg-white">
  <div class="container text-center">
    ...
    <div class="swiper trustedSwiper">
      <div class="swiper-wrapper">
        <!-- Logo Items -->
        <div class="swiper-slide"><img src="images/1.png" alt="Hospital 1" class="img-fluid logo-item"></div>
        <div class="swiper-slide"><img src="images/2.png" alt="Hospital 2" class="img-fluid logo-item"></div>
        <div class="swiper-slide"><img src="images/3.png" alt="Hospital 3" class="img-fluid logo-item"></div>
        <div class="swiper-slide"><img src="images/4.png" alt="Hospital 4" class="img-fluid logo-item"></div>
        <div class="swiper-slide"><img src="images/5.png" alt="Hospital 5" class="img-fluid logo-item"></div>
        <div class="swiper-slide"><img src="images/6.png" alt="Hospital 6" class="img-fluid logo-item"></div>
      </div>
    </div>
  </div>
</section>
